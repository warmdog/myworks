...
<head>
	...
	/*function editAddress()
	{
		...
		/*$.ajax({
   				type: "POST",
   				url: "submit.php",
   				data: "provice=value1&city=value2&street=value3&detail=value4&phone=tel",
   				dataType: "json",
   				timeout : 10000,
				...
				alert( value2 + value3 + value4 + ":" + tel);
			}
		);
	}
...
<body>
	...
	<table >
        ...
        <tr>
            <td><label for="txtpswd">地址：</label></td>
            <td><input type="password" id="txtpswd" name="adress" /></td>
        </tr>
         <tr>
            <td><label for="txtpswd">手机号：</label></td>
            <td><input type="password" id="txpswd" name="phone" /></td>
        </tr>
        <tr>
            <td colspan=2>
                <input type="reset" />
