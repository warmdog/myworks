...
$input->SetNotify_url("http://admin.shequjia.cn/Wxpay/example/notify1.php");
		...
		WeixinJSBridge.invoke(
			...
			function(res){
				...
				if(res.err_msg=='get_brand_wcpay_request:ok'){
					alert("购买成功，请填写收货地址！");
					window.location.href="submit1.php?paystate=1"+"&fee="+fee+"&body="+body+"&store="+store;
...
<div class="panel panel-primary">
    <div class="panel-heading" style="margin-top: 0px">福利商城，便民到家，给您最贴心的服务！
    </div>
<div class="panel-body">
    <p style="display:none;"><b>商品名称：</b><span id="a"><?php echo htmlspecialchars($body);?></span></p>
...
<div style="width:100%; margin:20px auto; text-align:center;">
	<a href="index.html" style="color:#333;">福利抢购</a>&nbsp;&nbsp;
    <a href="center.html" style="color:#333;">个人中心</a>&nbsp;&nbsp;
    <a href="aboutus.html" style="color:#333;">关于我们</a>
</div>
