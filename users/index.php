				...
				<ul style="border-bottom:dotted 2px #999;">
					<li>
						...
						<?php include_once"rank.php";?>
							<text id="proPaiHang0">1</text>
							<p id="paiHang0"><?php echo $array[0]['name'].'出价'.$array[0]['max'].'哈币';?></p>
						</li>
						<li class="PaiHang">
							<text id="proPaiHang1">2</text>
							<p id="paiHang01"><?php echo $array[1]['name'].'出价'.$array[1]['max'].'哈币';?></p>
						</li>
						<li class="PaiHang">
							<text id="proPaiHang2">3</text>
							<p id="paiHang2"><?php echo $array[2]['name'].'出价'.$array[2]['max'].'哈币';?></p>
						</li>
						<li class="PaiHang">
							<text id="proPaiHang3">4</text>
							<p id="paiHang3"><?php echo $array[3]['name'].'出价'.$array[3]['max'].'哈币';?></p>
						</li>
						<li class="PaiHang">
							<text  id="proPaiHang4">5</text>
							<p id="paiHang4"><?php echo $array[4]['name'].'出价'.$array[4]['max'].'哈币';?></p>
						</li>
						<li class="PaiHang">
							<text id="proPaiHang5">商品名称</text>
							<p id="paiHang5"><?php echo $array[5]['name'].'出价'.$array[5]['max'].'哈币';?></p>
						</li>
						<li class="PaiHang">
							<text id="proPaiHang6">商品名称</text>
							<p id="paiHang6"><?php echo $array[6]['name'].'出价'.$array[6]['max'].'哈币';?></p>
						</li>
						<li class="PaiHang">
							<text id="proPaiHang7">商品名称</text>
							<p id="paiHang7"><?php echo $array[7]['name'].'出价'.$array[7]['max'].'哈币';?></p>
						</li>
						<li class="PaiHang">
							<text id="proPaiHang8">商品名称</text>
							<p id="paiHang8"><?php echo $array[8]['name'].'出价'.$array[8]['max'].'哈币';?></p>
						</li>
					<li>
...
<div>
	<script type="text/javascript">
		...
		$(
			function(){
				for(var i=0;i<9;i++){
					//初始化排行榜商品名
					var namePaiHang=$("#name"+(i+1));
					$("#proPaiHang"+i).html(namePaiHang);
					//初始化排行结果
					var resultPaiHang=$("#paiHang"+i).html();
					if(resultPaiHang=="出价哈币"){
						$("#paiHang"+i).html("暂无人出价");
					}
				}
			}
		);
	...
	<div id="resultPai" style="display:none;">
		<div onclick="welfare();" style="font-size:14px;position:fixed;right:10px;top:0px;color:#333;">
			<br/>
				前往拍卖大厅>>>
		</div>
		<br/><br/><br/><br/>
