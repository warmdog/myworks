		...
		WeixinJSBridge.invoke(
			...
			function(res){
				...
				if(res.err_msg=='get_brand_wcpay_request:ok'){
					alert("购买成功！");
					window.location.href="http://wx.shequjia.cn/api/create.php";
...
<div class="panel-body">
    <p ><b>商品名称：</b><span id="a"><?php echo htmlspecialchars($body);?></span></p>
...
<div style="width:100%; margin:20px auto; text-align:center;">
	<a href="http://wx.shequjia.cn/mybootstrap/store.html" style="color:#333;">福利抢购</a>&nbsp;&nbsp;
    <a href="http://wx.shequjia.cn/mybootstrap/center.html" style="color:#333;">个人中心</a>&nbsp;&nbsp;
    <a href="http://wx.shequjia.cn/mybootstrap/aboutus.html" style="color:#333;">关于我们</a>
</div>
