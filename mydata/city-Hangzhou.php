          ...
          <div id="collapse-panel-1" class="am-in">
            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
              ...
              <tr>
                ...
                <td>新用户</td>
                <td><?php echo $HangzhouState0[0] ;?></td>
              </tr>
              <tr>
                <td class="am-text-center"></td>
                <td>申请中</td>
                <td><?php echo $HangzhouState1[0] ;?></td>
              </tr>
              <tr>
                <td class="am-text-center"></td>
                <td>搭建中</td>
                <td><?php echo $HangzhouState2[0] ;?></td>
              </tr>
              <tr>
                <td class="am-text-center"></td>
                <td>审核中</td>
                <td><?php echo $HangzhouState3[0] ;?></td>
              </tr>
              <tr>
                <td class="am-text-center"></td>
                <td>对接中</td>
                <td><?php echo $HangzhouState4[0] ;?></td>
              </tr>
              <tr>
                <td class="am-text-center"></td>
                <td>运营中</td>
                <td><?php echo $HangzhouState5[0] ;?></td>
              </tr>
              </tbody>
            </table>
          </div>
